# Computer Aided Inc — Junior Data Engineer

**URL:** https://cai.wd5.myworkdayjobs.com/en-US/computer_aid/job/FL-CLIENT-STATE/Junior-Data-Engineer_R7496
...
CV keywords present: `Python`, `SQL`, `Data pipelines`, `ETL`, `Government contracts`
...
Why: Small consulting firm. Data engineering role for government clients. Government contracting overhead.
...
- Consulting firm (billable hours)
- Government compliance burden
- Limited autonomy expected
...
**3.1/5 = WEAK MATCH — recommend passing**
