# KBR — Junior Communications Systems Software Engineer
...
CV keywords present: `C`, `C++`, `Communications systems`, `Defense`, `Low-level`
...
Why: Defense engineering firm. C/C++ focus. Systems-level work. Onsite requirement. Slow-moving govt contracts.
...
- Onsite requirement (Ohio)
- Defense/govt only
- Legacy embedded systems likely
- Clearance required
...
**3.3/5 = WEAK MATCH — recommend passing**
