...
CV keywords present: `Java`, `SQL`, `Defense systems`, `Government`, `Established`
...
Why: Large defense/tech contractor. Government-heavy. Columbia location (onsite likely). Bureaucratic environment.
...
**3/5 = WEAK MATCH — recommend passing**
