# Unum — IT Associate - Software Engineer

**URL:** https://unum.wd1.myworkdayjobs.com/en-US/external/job/Chattanooga-Tennessee-USA/IT-Associate---Software-Engineer_835051
...
CV keywords present: `Java`, `Spring`, `SQL`, `Healthcare IT`, `Monolithic systems`
...
Why: Health insurance company (established). IT-focused role, legacy tech stack expected. Limited growth opportunity for new grad.
...
- Established company
- Likely legacy tech
- Limited AI/ML mentions
- Healthcare regulatory overhead
...
**2.8/5 = WEAK MATCH — recommend passing**
