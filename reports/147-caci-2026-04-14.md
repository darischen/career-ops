# CACI International — Junior C++ Software Engineer
...
CV keywords present: `C++`, `Systems programming`, `Defense`, `Low-level`, `Security clearance`
...
Why: Defense contractor. C++ systems programming. Security clearance likely required. Constrained by govt regulations.
...
- Defense contractor (restricted)
- C++ only (not full-stack)
...
**3.4/5 = WEAK MATCH — recommend passing**
