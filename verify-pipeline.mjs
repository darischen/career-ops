...
const ALIASES = {
  'sent': 'applied', 'submitted': 'applied', 'applied': 'applied', 'sent': 'applied',
  'closed': 'discarded', 'discarded': 'discarded', 'cancelled': 'discarded',
  'rejected': 'rejected',
  'no_apply': 'no apply', 'skip': 'no apply', 'monitor': 'no apply',
};
