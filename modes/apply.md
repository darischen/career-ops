...
IF A RESUME SCORES WITHIN 10 POINTS OF EACH OTHER, EXPLAIN WHY YOU ARE RECOMMENDING THE FINAL CHOICE BASED ON PDF ANALYSIS.
CRITICAL: DO NOT WRITE THIS TO output/essay.txt. THIS MUST BE PRINTED TO THE TERMINAL FOR IMMEDIATE USER REVIEW.
